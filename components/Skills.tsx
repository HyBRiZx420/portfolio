    ...
    return (
        <>
            <div className="w-full px-3 py-4 rounded-xl flex flex-col gap-2 bg-slate-950 shadow-lg border-2  border-green-500">
                ...
                <Section>
                    <p className="font-bold text-2xl pt-2 pb-3"> Abschlüsse </p>
                    <p className="text-1xl pt-2 pb-0">
                ...
                <Section>
                    <p className="font-bold text-2xl pt-2 pb-3"> Sprachen </p>
                    <p className="text-1xl pt-2 pb-0"> Deutsch, Muttersprache</p>
                    <p className="text-1xl pt-2 pb-0"> Englisch (B2)</p>
                </Section>
            </div>
        </>
    );
